...
详见 ADR-0009、`docs/specifications/ai-development-assurance.md` 与 2026 专题研究。该治理属于实现质量控制，不解除功能型文档冻结。
...
- AIQA Phase 0a 门禁：隔离 agent、Evidence Bundle、trusted CI、protected gates、依赖审批和 accountable owner。
...
1. 建立 workspace、Fovea/ImageCraft/Akashic SwiftPM 壳与最小 AI Code Assurance 底座（隔离 agent、trusted CI、Evidence Bundle、protected gates），使用 path dependency。
...
8. 把 `TEST_CATALOG.md` 的 Phase 0a 与 `AIQA-GATE` ID 转成自动化/可审计门禁。
