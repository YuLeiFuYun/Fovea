...
CACHE-PT-043...045    自定义 RenderedImageCaching 与 qualified persistent-store provider 的所有权/描述符门禁
CACHE-PT-046...049    非法 handoff 删除、新鲜 completion handoff、禁止范围与负证明撤销
...
SCHED-PT-025      completed-only negative evidence removal cannot delete or cancel an active exact-key task
...
COMP-PT-020       W7 V8 fixes exactly 1,000 logical requests, constructs all 512 shared loads behind a response-delivery-only preparation gate, proves the gate engaged, preserves native enrollment and direct cancellation, keeps the common eight-slot service curve/client budget, internal eight-grant and derived fifteen-start fairness bounds, absolute peak threads, six A-tier headless comparators, B-tier isolation, and versioned preregistration before formal evidence
