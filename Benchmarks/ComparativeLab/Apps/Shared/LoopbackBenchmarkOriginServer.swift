...
final class LoopbackBenchmarkOriginServer: @unchecked Sendable {
    ...
    func snapshot() -> BenchmarkOriginMetrics {
        ...
        return BenchmarkOriginMetrics(
            ...
            postCancellationCompletedBytes: 0,
            postCancellationCompletedRequestCount: 0,
            postCancellationCompletedBytesP50: 0,
            postCancellationCompletedBytesP95: 0,
            postCancellationCompletedBytesMaximum: 0,
            postCancellationAbandonedBytes: 0,
            postCancellationAbandonedRequestCount: 0,
            postCancellationAbandonedBytesP50: 0,
            postCancellationAbandonedBytesP95: 0,
            postCancellationAbandonedBytesMaximum: 0,
            cancellationAcknowledgementCount: 0,
            cancellationAcknowledgementP95Nanoseconds: 0,
            cancellationAcknowledgementMaximumNanoseconds: 0,
            completedRequestCount: completedRequestCount,
            latestCompletedAtNanoseconds: 0,
            completedRequestDurationP50Nanoseconds: 0,
            completedRequestDurationP95Nanoseconds: 0,
            completedRequestDurationMaximumNanoseconds: 0,
